...
export default function SystreeDialog({elementDialogData, setElementDialogData}: {elementDialogData: IElement | null, setElementDialogData: Dispatch<SetStateAction<IElement | null>>}) {
    const { addMessage } = useHeaderMessages();
    const { data: elementData, isPending, isError} = useSystreeQuery.getElement(elementDialogData?.id);
